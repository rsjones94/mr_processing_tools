function [ ase2d, ase3d, simvec ] = ASE_2Dvals_v1( patdir )
% SLW wrote this function to grab region values from 2D images. You have to
% coregister the images to 3D space. Turns out that's harder than
% originally anticipated.
    ...
    ase3d=dir([patdir,'/Acquired/*ms_ASE*.PAR']);
    ...
    ase3dmaskmat=[];
    for i = 1:length(ase3d)
        asemat=readrec_V4_2(ase3d(i).name);
    ...
    %%%% coregistered to.
    ase2d=[dir([patdir,'/Acquired/*ss_ASE*.PAR']);dir([patdir,'/Acquired/*VASOASE*.PAR'])];
